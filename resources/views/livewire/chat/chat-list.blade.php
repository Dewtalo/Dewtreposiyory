                            ...
                            <x-slot name="content">
                                <div class="w-full p-1">
                                    <button class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-500 hover:bg-gray-100 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100">
                                        ...
                                        <a href="{{ route('profile', ['user_id' => $conversation->getReceiver()->id]) }}">View Profile</a>
                                        @elseif(Auth::id()===$conversation->getReceiver()->id)
                                        <a href="{{ route('profile', ['user_id' => $conversation->messages?->last()?->sender_id]) }}">View Profile</a>
                                        @endif
                                        <span>
                                        ...
                                        Send a message to see the profile of this user!
